...
def load_data(file_path : str) -> pd.DataFrame:
    ...
    try:
        ...
        logger.error("unexcepted error occured while loading the dats %s",e)
        raise
...
def save_metrics(metrics : dict,file_path : str) -> None:
    """ Save te evaluation metrics to a json file """
    try:
...
def main():
    try:
        ...
        save_metrics(metrics=metrics,file_path="report/metrics.json")
